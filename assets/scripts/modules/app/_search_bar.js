...
class SearchBar{
    ...
    init(){
        ...
        let topDisplacement = this.searchBar.clientHeight + this.navbar.clientHeight;
        ...
        this.navbarSupportedContent.setAttribute('style', 'top: '+topDisplacement+'px');
        ...
        if (this.productDialog !== null)
            this.productDialog.setAttribute('style', 'top: '+navbarDisplacement+'px');
    }
