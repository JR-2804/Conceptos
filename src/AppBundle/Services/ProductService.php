...
class ProductService
{
    ...
    public function calculateProductPrice(
        ...
        if (($isFurniture && !$isAriplaneForniture) || ($isMattress && !$isAriplaneMattress)) {
          ...
          return ceil(
            ($ikeaPrice*1.2 + $weight*4.4 + $numberOfPackagesExtra + $mattressExtra + $grillExtra + $shelfExtra + $deskExtra + $bookcaseExtra + $comodaExtra + $repisaExtra + 20)*1.8
          );
        } else {
          ...
          return ceil(
            ($ikeaPrice*1.2 + $weight*16 + $fragileExtra + $lampExtra + $oversizeExtra + $mattressExtra + $tablewareExtra + $faucetExtra + $grillExtra + $shelfExtra + $deskExtra + $bookcaseExtra + $comodaExtra + $repisaExtra)*1.8
          );
        }
    }
